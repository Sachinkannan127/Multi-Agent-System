...
import { Send, Bot, User, RefreshCw, Cpu, Sparkles, Terminal } from 'lucide-react';
        ...
        <div>
          <div className="flex items-center justify-between mb-4">
            ...
            <button
              ...
              className="p-1 rounded-lg text-slate-400 hover:text-purple-400 hover:bg-white/5 transition cursor-pointer"
          ...
          <div className="space-y-1.5">
            {quickPrompts.map((qp, idx) => (
              <button
                ...
                className="w-full text-left p-2 rounded-lg bg-slate-900/40 hover:bg-purple-900/20 border border-slate-800 hover:border-purple-500/30 text-xs text-slate-300 transition cursor-pointer"
              >
