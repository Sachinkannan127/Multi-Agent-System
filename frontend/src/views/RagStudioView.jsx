...
import { Upload, Layers, Search, FileText, CheckCircle2, AlertCircle } from 'lucide-react';
      ...
      <div className="glass-panel p-6 flex items-center justify-between">
        <div>
          ...
          <p className="text-xs text-[var(--text-muted)] mt-1">
            Combines Dense Vector Search, Sparse BM25 Term Frequency Search, and Reciprocal Rank Fusion (RRF).
          </p>
        </div>
